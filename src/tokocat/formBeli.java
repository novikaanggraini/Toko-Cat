...
public class formBeli extends javax.swing.JFrame {
   ...
   public final void loadData() {
        ...
        try {
            ...
            while (r.next()) {
                ...
                o[1] = r.getString("kode_cat");
                o[2] = r.getString("nama_cat");
    ...
    private void tampilpilih() {
        try {
            ...
            String sql = "SELECT nama_cat FROM cat WHERE jumlah_cat !='0'";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                pilihbarang.addItem(r.getString("nama_cat"));
            }
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        setTitle("Halaman Transaksi Warna Mas Cat");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel1.setBackground(new java.awt.Color(0, 47, 95));
        ...
        jPanel3.setBackground(new java.awt.Color(0, 82, 185));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 935, 529));
    ...
    private void pilihbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihbarangActionPerformed
        ...
        try {
            ...
            String sql = "SELECT kode_cat, jumlah_cat FROM cat WHERE nama_cat ='" + pilihbarang.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);

            while (r.next()) {
                kdbarang.setText(r.getString("kode_cat"));
                jumlah.setText(r.getString("jumlah_cat"));
            }
        ...
        try {
            ...
            String sql = "SELECT harga_jual FROM cat WHERE nama_cat ='" + pilihbarang.getSelectedItem() + "'";
            ResultSet r = s.executeQuery(sql);
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        // TODO add your handling code here:
         if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "Warna Mas - Toko Cat", JOptionPane.INFORMATION_MESSAGE);
        ...
        if(aa > bb){
             JOptionPane.showMessageDialog(null, "jumlah melebihi stok", "Warna Mas - Toko Cat", JOptionPane.INFORMATION_MESSAGE);
             tjumlah.setText("");
        }else{
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            ...
            try {
                ...
                tjumlah.setText("");
                ttotal.setText("");
                JOptionPane.showMessageDialog(null, "Data berhasil disimpan", "Warna Mas - Toko Cat", JOptionPane.INFORMATION_MESSAGE);
                loadData();
        ...
        // TODO add your handling code here:
         if(jTextField3.getText().equals("") ||jTextField1.getText().equals("")){
            ...
            int ab = Integer.parseInt(String.valueOf(jTextField1.getText()));
              if(ab < 0){
                JOptionPane.showMessageDialog(null, "Uang anda kurang", "Warna Mas - Toko Cat", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
            jTextField1.setText("");
              }else{
           try {
            ...
            while (r.next()) {
                ...
                p.setString(2, r.getString("kode_cat"));
                p.setString(3, r.getString("nama_cat"));
         ...
         try {
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "TRANSAKSI SELESAI", "Warna Mas - Toko Cat", JOptionPane.INFORMATION_MESSAGE);
            loadData();
